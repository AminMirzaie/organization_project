    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roll', models.CharField(choices=[('AD', 'admin'), ('MG', 'manager'), ('WK', 'worker'), ('OW', 'org_worker')], default='WK', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2020, 5, 9, 20, 21, 39, 655079, tzinfo=utc))),
                ('deadline', models.DateTimeField(default=datetime.datetime(2020, 5, 9, 20, 21, 39, 655105, tzinfo=utc))),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles_api.Organization')),
