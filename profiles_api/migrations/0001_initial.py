    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2020, 5, 8, 20, 58, 57, 194602))),
                ('deadline', models.DateTimeField(default=datetime.datetime(2020, 5, 15, 20, 58, 57, 194636))),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles_api.Organization')),
